...
CREATE TABLE transactions (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, recordsid integer(10) NOT NULL, transaction_name varchar(255), context_name varchar(255), start_time timestamp, stop_time timestamp, FOREIGN KEY(recordsid) REFERENCES records(id));
