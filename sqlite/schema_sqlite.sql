...
/* SDK based component name, the id is not relevant outside of the database and it is assigned automagical by the DB */;
...
CREATE TABLE valuemap (valuemap_id INTEGER PRIMARY KEY,
                       ...
                       component_value NUMERIC) WITHOUT ROWID; /* can store any type but numeric is preferred */
/* Values can be logged to multiple records simultaneously */;
...
----------------------------+-------------+-------------+----------------+--------------------
 2016-10-06 11:58:34.504319 |     default |  someEntity |  someComponent | 2.3536
 2016-10-06 11:58:34.529059 |     default |  someEntity |  someComponent | some string
 2016-10-06 11:58:34.553821 |     default |  someEntity |  someComponent | {9.2453,36.436347}
*/;
