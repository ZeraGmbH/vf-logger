...
void test_testdatabase::openDatabaseErrorEarly()
{
    ...
    m_testSystem.setControlComponent(dataLoggerEntityId, "DatabaseFile", TestLoggerDB::DBNameOpenErrorEarly);
...
{
    m_testSystem.setupServer();
    m_testSystem.setControlComponent(dataLoggerEntityId, "DatabaseFile", TestLoggerDB::DBNameOpenErrorLate);
...
void test_testdatabase::selectExistingSession()
{
    ...
    m_testSystem.appendCustomerDataSystem();
    m_testSystem.loadDatabase();
    m_testSystem.setControlComponent(dataLoggerEntityId, "sessionName", "DbTestSession1");
...
void test_testdatabase::recordStartStop()
{
    ...
    m_testSystem.setComponentValuesSequenceEach(10);
...
{
    m_testSystem.setupServer(3, 3);
    m_testSystem.setControlComponent(dataLoggerEntityId, "currentContentSets", QVariantList() << "TestSet1"); // LOL
    m_testSystem.setComponentValuesSequenceEach(1);
...
void test_testdatabase::openRunLogAndClose()
{
    ...
    m_testSystem.setControlComponent(dataLoggerEntityId, "DatabaseFile", "");
...
void test_testdatabase::guiContextMakesItIntoDbAndVein()
{
    ...
    m_testSystem.setControlComponent(dataLoggerEntityId, "currentContentSets", QVariantList() << "TestSet1");
    m_testSystem.setControlComponent(dataLoggerEntityId, "guiContext", "TestGuiContext");
