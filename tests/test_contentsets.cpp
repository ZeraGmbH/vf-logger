...
{
    m_testSystem.setControlComponent(dataLoggerEntityId, "currentContentSets", "TestSet1"); // this is a bug - stored value must be a list!!!
...
{
    m_testSystem.setControlComponent(dataLoggerEntityId, "currentContentSets", "foo");
...
{
    m_testSystem.setControlComponent(dataLoggerEntityId, "currentContentSets", QVariantList() << "TestSet1");
...
{
    m_testSystem.setControlComponent(dataLoggerEntityId, "currentContentSets", QVariantList() << "TestSet1" << "TestSet2");
...
{
    m_testSystem.setControlComponent(dataLoggerEntityId, "currentContentSets", QVariantList() << "TestSet1" << "TestSet1");
...
{
    m_testSystem.setControlComponent(dataLoggerEntityId, "currentContentSets", QVariantList() << "TestSet2");
    m_testSystem.setControlComponent(dataLoggerEntityId, "currentContentSets", QVariantList() << "TestSet1");
...
void test_contentsets::contentSetsSelectValid3SessionChange()
{
    ...
    m_testSystem.setControlComponent(dataLoggerEntityId, "currentContentSets", QVariantList() << "TestSet3");
...
{
    m_testSystem.changeSession();
    m_testSystem.setControlComponent(dataLoggerEntityId, "currentContentSets", QVariantList() << "TestSet4");
