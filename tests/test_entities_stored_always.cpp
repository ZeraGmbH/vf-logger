...
void test_entities_stored_always::recordEntitiesStoredAlwaysAndOthers()
{
    ...
    m_testSystem.setControlComponent(dataLoggerEntityId, "LoggedComponents", onDemandLoggedComponents);
    m_testSystem.setComponentValuesSequenceEach(1);
...
void test_entities_stored_always::recordEntitiesStoredAlwaysTwoRecordings()
{
    ...
    m_testSystem.setControlComponent(dataLoggerEntityId, "LoggedComponents", QVariantMap()); // remove 12
    m_testSystem.setDataComponent(10, "ComponentName1", "AfterRestart1");
    m_testSystem.setDataComponent(10, "ComponentName2", "AfterRestart2");
